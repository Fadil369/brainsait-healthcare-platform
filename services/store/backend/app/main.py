...
# Serve static Next.js export bundled in image under ./static
# (Static mount moved to the end of the file to avoid overshadowing API routes)
...
# Serve static Next.js export bundled in image under ./static, added after routers
