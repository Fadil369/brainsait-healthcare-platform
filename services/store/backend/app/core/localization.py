...
class LocalizedResponse(JSONResponse):
    """Simple wrapper to return JSON with a Content-Language header."""
    def __init__(self, content: Any, language: str = "en", status_code: int = 200):
...
def get_localized_text(key: str, language: str = "en", **kwargs) -> str:
    """Compatibility helper used by some APIs; delegates to get_localized_message."""
    return get_localized_message(key=key, language=language, **kwargs)
